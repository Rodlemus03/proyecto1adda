...
pdf.ln(10)
# Graficar dispersión de tiempos
plt.figure(figsize=(8,5))
plt.scatter(df["N"], df["Execution Time (s)"], label="Tiempos de ejecución")
plt.xlabel("N (Tamaño de Entrada)")
plt.ylabel("Tiempo de Ejecución (s)")
plt.title("Tiempo de Ejecución de la Máquina de Turing de Fibonacci")
plt.legend()
